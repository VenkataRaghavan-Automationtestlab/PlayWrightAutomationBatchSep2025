 ...
 * Provides static methods to start/stop Playwright, launch browsers, create
 * contexts, and open new pages. Ensures only one Playwright instance exists per
 * test run.
 */
public class PlaywrightFactory {
 ...
 // --- Lifecycle ---
    ...
    /**
	 * Closes the active browser and Playwright instance. Ensures clean shutdown
    ...
    private static BrowserType selectBrowserType() {
        switch (browserName) {
            ...
            case "chrome":
            case "msedge":
            case "chromium": // explicit chromium support
